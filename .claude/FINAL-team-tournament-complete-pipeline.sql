-- =====================================================
-- FINAL: Complete Team Tournament Data Pipeline
-- =====================================================
-- This file consolidates all working queries for team tournament data processing
-- Version: FINAL (Tested and Working)
-- Date: 2025-11-27
-- =====================================================


-- =====================================================
-- PART 1: SYNC TEAM PLAYERS TO ACTIVE_PLAYERS TABLE
-- =====================================================
-- Source: team-tournament-active-players-sync-hardened.sql
-- Purpose: Sync team tournament player data to active_players_august_2025_profiles
-- Note: Team tournaments initially have NULL tie_breaks and performance_rating
-- Run this FIRST after uploading team tournament data
-- =====================================================

-- See: team-tournament-active-players-sync-hardened.sql for complete workflow
-- Key Steps:
-- 1. Pre-flight validation (Step 0)
-- 2. Identify new players (Step 1)
-- 3. Match with registry (Step 2)
-- 4. Preview insertion (Step 3)
-- 5. Execute insertion (Step 4)
-- 6. Verify results (Step 5)


-- =====================================================
-- PART 2: CALCULATE PERFORMANCE RATINGS
-- =====================================================
-- Source: update-team-tournament-performance-WORKING.sql
-- Purpose: Calculate performance ratings and tie-breaks for team tournament players
-- Run this AFTER Part 1 to populate performance_rating and tie_breaks fields
-- =====================================================
...
/*
WORKFLOW:
1. Upload team tournament files via admin interface
2. Run PART 1 (team-tournament-active-players-sync-hardened.sql) to sync players to active_players table
3. Run PART 2 (this file, performance calculation section) to calculate ratings
4. Verify results in rankings page

PERFORMANCE RATING FORMULA:
- For each game, calculate: opponent_rating + result_adjustment
  - Win: +400
  - Draw: +0
  - Loss: -400
...
TIE-BREAKS:
- TB1: Number of wins
- TB2: Buchholz (sum of opponent ratings)
- TB3: Sonneborn-Berger (weighted sum)

SAFETY FEATURES:
- Only updates records with NULL performance_rating (prevents overwriting)
- Excludes forfeit games
- Requires valid opponent ratings
- Atomic updates with proper WHERE clauses
*/
