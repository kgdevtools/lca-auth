...
import LichessSyncTrigger from "@/components/academy/LichessSyncTrigger.client";
import {
  Card,
  CardContent,
  CardDescription,
...
export default async function AcademyDashboard() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      {/* Silent background sync — only fires for students with a Lichess connection */}
      {profile.role === "student" && <LichessSyncTrigger />}
      {/* Header */}
          ...
          <div className="space-y-4">
            ...
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <p className="text-sm text-blue-800 dark:text-blue-300">
                <strong>Next steps:</strong> Use the sidebar navigation to
                explore the academy features. Start with the Lessons section to
